Papa.parse("../Data/LokasiLengkap_Rekreasi.csv", {
  download: true,
  header: true,
  complete: function(results) {
    ...
    function renderCards(data, limit = showingCount) {
      ...
      data.slice(0, limit).forEach(row => {
        ...
        const imgUrl = row.foto || "https://via.placeholder.com/180x120?text=No+Image";
    ...
    function openModal(data) {
      const imgUrl = data.foto || "https://via.placeholder.com/300x200?text=No+Image";
        ...
        <div class="tour-card">
          ...
          <div class="card-content">
            ...
            <p class="phone">${data.kontak || '-'}</p>
             ...
             <div class="buttons">
               <button class="btn route-btn" onclick="openRoutingPage(${data.x}, ${data.y})">Lihat Rute</button>
...
function openRoutingPage(destinationName) {
  ...
  window.open('../HTML/RoutingRecreation.html', '_blank');
}
